...
<html lang="pt-BR" class="no-js">
  <head>
    ...
    <meta property="og:image" content="https://nailnow.app/assets/nail1.png" />
    ...
    <meta name="twitter:image" content="https://nailnow.app/assets/nail1.png" />
  ...
  <body class="local-seo-page">
    ...
    <main>
      ...
      <section class="local-section">
        <h2>Quanto ganha uma manicure a domicílio em ${b.bairro}?</h2>
        <p>Ganho por atendimento fica entre <strong>R$ ${b.salarioMin} e R$ ${b.salarioMax}</strong>, dependendo do serviço. Alguns exemplos dos serviços mais pedidos:</p>
        <ul class="local-highlights">
          <li>Mão tradicional — a partir de R$ 30 (60 min)</li>
          <li>Pé e Mão tradicional — a partir de R$ 70 (90 min)</li>
          <li>Mão em gel — a partir de R$ 60 (75 min)</li>
          <li>Pé e Mão em gel — a partir de R$ 115 (150 min)</li>
          <li>Blindagem — a partir de R$ 90 (90 min)</li>
        </ul>
        <p>Você define os seus preços (respeitando o mínimo por serviço). O repasse é direto na sua conta com split automático. Sem taxa fixa mensal.</p>
      </section>
